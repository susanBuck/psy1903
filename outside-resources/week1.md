...
## AI Prompts
+ What does the `-l` option do in the command `wc -l`?
+ Does JavaScript have a method to reverse a string?
...
## Outside sites
+ [MDN JavaScript TypeError](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypeError)
+ [wc - man page](https://linux.die.net/man/1/wc)
+ <https://stackoverflow.com/questions/44421810/typeerror-in-typescript>
